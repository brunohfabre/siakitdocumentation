...
const exampleCode = `import { Pin } from '@atmoutsourcing/siakit';

<Pin />`;

export function PinPage(): JSX.Element {
  const formRef = useRef<FormHandles>(null);

  return (
    <Flex flex direction="column" align="center" overflow>
      <Flex width={768} padding={32} direction="column" gap>
        <Heading size="xl">Pin</Heading>
        <Card>
        ...
        <SimpleTable>
          ...
          <SimpleTableBody>
            ...
            <SimpleTableItem>amount</SimpleTableItem>
            <SimpleTableItem>number</SimpleTableItem>
            <SimpleTableItem>4</SimpleTableItem>
