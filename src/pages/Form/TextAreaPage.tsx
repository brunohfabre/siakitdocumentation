...
const exampleCode = `import { TextArea } from '@atmoutsourcing/siakit';
  ...
  return (
    <Flex flex direction="column" align="center" overflow>
      <Flex width={768} padding={32} direction="column" gap>
        <Heading size="xl">TextArea</Heading>
        <Card>
          <Flex flex height={192} padding justify="center" align="center">
            <Form ref={formRef} onSubmit={() => undefined}>
              <Flex direction="column" padding={32}>
                <TextArea name="name" label="Label" placeholder="Placeholder" />
              </Flex>
            </Form>
          </Flex>
        </Card>
        ...
        <SimpleTable>
          ...
          <SimpleTableBody>
            ...
            <SimpleTableItem>rows</SimpleTableItem>
            <SimpleTableItem>number</SimpleTableItem>
            <SimpleTableItem>5</SimpleTableItem>
